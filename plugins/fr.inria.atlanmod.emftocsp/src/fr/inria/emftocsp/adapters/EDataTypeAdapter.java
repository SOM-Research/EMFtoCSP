...
public abstract class EDataTypeAdapter<D> implements EDataType, Holder {

	protected D origEDataType;
	
	public EDataTypeAdapter(D newDataType){
		origEDataType = newDataType;
	}
